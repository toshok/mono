...
void sgen_queue_finalization_entry (GCObject *obj) MONO_INTERNAL;
...
void sgen_null_links_with_null_vtable (int generation) MONO_INTERNAL;
...
void sgen_remove_finalizers_with_predicate (SgenObjectPredicateFunc predicate, void *user_data, int generation) MONO_INTERNAL;
...
void sgen_parallel_pin_or_update (void **ptr, void *obj, GCVTable *vt, SgenGrayQueue *queue) MONO_INTERNAL;
...
void sgen_stop_world (int generation) MONO_INTERNAL;
void sgen_restart_world (int generation, GGTimingInfo *timing) MONO_INTERNAL;
...
void* sgen_los_alloc_large_inner (GCVTable *vtable, size_t size) MONO_INTERNAL;
...
void sgen_init_allocator (void) MONO_INTERNAL;
...
void* sgen_alloc_obj_nolock (GCVTable *vtable, size_t size) MONO_INTERNAL;
void* sgen_try_alloc_obj_nolock (GCVTable *vtable, size_t size) MONO_INTERNAL;
...
void mono_gc_scan_for_specific_ref (GCObject *key, gboolean precise) MONO_INTERNAL;
...
void sgen_debug_verify_nursery (gboolean do_dump_nursery_content) MONO_INTERNAL;
void sgen_debug_check_nursery_is_clean (void) MONO_INTERNAL;
